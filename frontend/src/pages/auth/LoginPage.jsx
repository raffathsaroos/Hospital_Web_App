...
export default function LoginPage() {
  ...
  async function submit(event) {
    // Persist the token and return users to the protected page they originally requested.
    ...
    <div className="grid min-h-screen bg-slate-100 lg:grid-cols-2">
      <div className="hidden bg-gradient-to-br from-blue-700 to-slate-800 p-12 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div>
          ...
          <h1 className="mt-6 max-w-lg text-4xl font-bold">
            One secure workspace for coordinated hospital care.
          </h1>
          <p className="mt-4 max-w-lg text-blue-100">
            Access is limited to accounts created and activated by the hospital
            administrator.
          </p>
        </div>
        ...
        <Card className="w-full max-w-md">
          <CardHeader>
            <Button
              variant="ghost"
              asChild
              className="mb-4 w-fit px-0 text-slate-500"
            >
              <Link to="/">
            ...
            <CardDescription>
              Use the account provided by your administrator. There is no public
              signup.
            </CardDescription>
          </CardHeader>
          <CardContent>
